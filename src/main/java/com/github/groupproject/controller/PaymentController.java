...
public class PaymentController {
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "PAyment created"),
                           @ApiResponse(code = 500, message = "Invalid API transaction or employee bonus promise key")})
    public void create (@ApiParam(value = "Add API transaction key", required = true, defaultValue = "uuid4")@RequestParam(name = "API transaction key") String transactionUuid,
                       @ApiParam(value = "Add API employee bonus promise key", required = true, defaultValue = "uuid5")@RequestParam(name = "API EBP key") String ebpUuid){
    ...
    public Set<PaymentDto> findAllByEBPClientUserUuid(@ApiParam(value = "Add Api user key", required = true, defaultValue = "uuid")@PathVariable String userUuid){
    ...
    public Set<PaymentDto> findAllByEbpClientUuid(@ApiParam(value = "Add API client key", required = true, defaultValue = "uuid1")@PathVariable String clientUuid){
    ...
    public Set<PaymentDto> findAllByEbpEmployeeUuid(@ApiParam(value = "Add API employee key", required = true, defaultValue = "uuid3")@PathVariable String employeeUuid){
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "Successful - payment list returned"),
                           @ApiResponse(code = 500, message = "Invalid API bonus key")})
    public Set<PaymentDto> findAllByEbpBonusUuid(@ApiParam(value = "Add API bonus key", required = true, defaultValue = "uuid2")@PathVariable String bonusUuid){
